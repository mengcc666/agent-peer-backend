...
public class Connect {
    ...
    @GetMapping("connect/invokeChaincode/InitLedger")
    public String invokeChaincodeInitLedger() {
        ...
        String str="Invoked 'InitLedger' chaincode";
        return str;
    }

    @GetMapping("connect/invokeChaincode/GetAllAssets")
    public String invokeChaincodeGetAllAssets() {
        // connect to the network and invoke the smart contract
        try (Gateway gateway = connect()) {
            // get the network and contract
            Network network = gateway.getNetwork("mychannel");
            ...
            String str="Invoke successfully!\n Result:\n"+new String(result);
            return str;
        }
        catch(Exception e){
            System.err.println(e);
        }
        String str="Invoked 'GetAllAssets' chaincode";
        return str;
    }
